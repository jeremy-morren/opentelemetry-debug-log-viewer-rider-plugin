...
import io.github.ozkanpakdil.opentelemetry.settings.converters.StringArrayPropertyConverter;
import kotlin.Unit;
...
@State(
        name = "io.github.ozkanpakdil.opentelemetry.settings.ProjectSettingsState",
